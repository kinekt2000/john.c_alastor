...
#include "../../light_1.1/light/grapher.h"
...
QT_MOC_LITERAL(17, 115, 13), // "rotate_signal"
QT_MOC_LITERAL(18, 129, 15), // "mousePressEvent"
QT_MOC_LITERAL(19, 145, 12), // "QMouseEvent*"
QT_MOC_LITERAL(20, 158, 5), // "event"
QT_MOC_LITERAL(21, 164, 14), // "mouseMoveEvent"
QT_MOC_LITERAL(22, 179, 17) // "mouseReleaseEvent"

    },
    "Grapher\0mouse_track_signal\0\0x\0y\0"
    "pen_signal\0square_signal\0sx\0sy\0fx\0fy\0"
    "copy_signal\0nx\0ny\0hexagon_signal\0"
    "radius\0angle\0rotate_signal\0mousePressEvent\0"
...
static const uint qt_meta_data_Grapher[] = {
 ...
 // signals: name, argc, parameters, tag, flags
      ...
      11,    6,   74,    2, 0x06 /* Public */,
      14,    4,   87,    2, 0x06 /* Public */,
      17,    3,   96,    2, 0x06 /* Public */,
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::Int, QMetaType::Int, QMetaType::Double,    7,    8,   15,
...
void Grapher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->rotate_signal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        ...
        {
            typedef void (Grapher::*_t)(int , int );
        ...
        {
            typedef void (Grapher::*_t)(int , int , int , int );
        ...
        {
            typedef void (Grapher::*_t)(int , int , int , int , int , int );
        ...
        {
            typedef void (Grapher::*_t)(int , int , double , double );
        ...
        {
            typedef void (Grapher::*_t)(int , int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Grapher::rotate_signal)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject Grapher::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_Grapher.data,
...
// SIGNAL 5
void Grapher::rotate_signal(int _t1, int _t2, double _t3)
{
